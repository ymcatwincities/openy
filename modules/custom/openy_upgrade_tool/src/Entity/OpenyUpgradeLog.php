 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}",
 *     "add-form" = "/admin/openy/settings/upgrade-log/add",
 *     "edit-form" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/edit",
 *     "delete-form" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/delete",
 *     "version-history" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/revisions",
 *     "revision" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/revisions/{openy_upgrade_log_revision}/view",
 *     "revision_revert" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/revisions/{openy_upgrade_log_revision}/revert",
 *     "revision_delete" = "/admin/openy/settings/upgrade-log/{openy_upgrade_log}/revisions/{openy_upgrade_log_revision}/delete",
 *     "collection" = "/admin/openy/settings/upgrade-log/dashboard",
 *   },
 * )
 */
