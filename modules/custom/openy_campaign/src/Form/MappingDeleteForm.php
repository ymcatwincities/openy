...
/**
 * Provides a form for deleting a openy_campaign_mapping_branch entity.
 *
 * @ingroup openy_campaign_mapping_branch
 */
class MappingDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.openy_campaign_mapping_branch.collection');
  }
