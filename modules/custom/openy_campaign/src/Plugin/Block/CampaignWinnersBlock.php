 ...
 *
 * @Block(
 *   id = "campaign_winners_block",
 *   admin_label = @Translation("Campaign Winners"),
 *   category = @Translation("Paragraph Blocks")
 * )
 */
class CampaignWinnersBlock extends BlockBase implements ContainerFactoryPluginInterface {
