 ...
 *   label = @Translation("Delete custom block"),
 *   type = "block_content",
 *   confirm_form_route_name = "block_content.multiple_delete_confirm",
 * )
 */
class BlockContentDelete extends ActionBase implements ContainerFactoryPluginInterface {
