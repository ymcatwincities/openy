...
(function($){
  ...
  (function()
    {
      // preprocess html of sidebar promos.
      jQuery('.sidebar-promos').

      var mainPromos    = jQuery('.main-promos > *').addClass('col-md-4 col-sm-6'),
          sidebarPromos = jQuery('.sidebar-promos > .richtext'),
          promos        = sidebarPromos;
      ...
      promos
        .each(
          function(){
            ...
            if(clickable && !links.hasClass('wrapper')) link.remove();
            el
              .wrapInner(wrapper)
              .children()
              .eq(0)
