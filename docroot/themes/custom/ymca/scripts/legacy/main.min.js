...
(function($){
  ...
  // decorate promos
  (function()
    { jQuery('.home-template .main-promos > .richtext').addClass('col-md-4 col-sm-6')
      var promos = jQuery('.sidebar-promos > .richtext, .main-promos > .main-promo .richtext, .home-template .main-promos > .richtext');
...
//				var $container	= $user_modals.find(component_id);
				...
				$carousel.append('<a class="left carousel-control hidden-sm cycle-prev hidden-xs"><span class="icon-prev"></span></a>');
				$carousel.append('<a class="right carousel-control hidden-sm cycle-next hidden-xs" ><span class="icon-next"></span></a>');
