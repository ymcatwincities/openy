...
use Drupal\plugin\PluginDefinition\FilterPluginDefinitionDecorator;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\plugin\PluginDefinition\FilterPluginDefinitionDecorator
 *
 * @group Plugin
 */
class FilterPluginDefinitionDecoratorTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\plugin\PluginDefinition\FilterPluginDefinitionDecorator
   */
  protected $sut;
  ...
  public function setUp() {
    ...
    $this->sut = new FilterPluginDefinitionDecorator($this->arrayDefinition);
  }
