  ...
  $(function () {
    ...
    setTimeout(function () {
      ...
      $sideBar.affix({
        offset: {
          top: function () {
            var offsetTop = $sideBar.offset().top - 4;
            var headerHeight = $('.top-navs').height() + parseInt($('.top-navs').css('margin-top'), 10);
            return (this.top = offsetTop - headerHeight);
          },
          bottom: function () {
...
;(function ($) {
  'use strict';
  var selector = '.bs-docs-section > h1[id], .bs-docs-section > h2[id], .bs-docs-section > h3[id], .bs-docs-section > h4[id], .bs-docs-section > h5[id]';
  anchors.options.placement = 'left';
  anchors.add(selector);

  // Move id to new element to make origin element not to be hidden under
  // affix menus.
  $(selector).each(function() {
    var id = $(this).attr('id');
    $(this).removeAttr('id');
    $('<a id="' + id + '" class="docs-pointer"></a>').insertBefore($(this));
  });

  // Links Style guide header variation links to corresponding pages.
  Drupal.behaviors.headingLinks = {
    attach: function(context, settings) {
      $('.sg-general-heading').attr('href', Drupal.url('styleguide'));
      $('.sg-camp-heading').attr('href', Drupal.url('styleguide/camp'));
      $('.sg-location-heading').attr('href', Drupal.url('styleguide/location'));
    }
  };
