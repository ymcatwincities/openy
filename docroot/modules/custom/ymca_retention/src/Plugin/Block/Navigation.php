...
class Navigation extends BlockBase {
  ...
  public function build() {
    $links = [
      'registration' => Link::fromTextAndUrl(t('Registration'), Url::fromRoute('<current>', [], [
        'fragment' => 'register-and-report',
      ])),
      'track_my_activity' => Link::fromTextAndUrl(t('Track My Activities'), Url::fromRoute('<current>', [], [
        'fragment' => 'register-and-report',
      ])),
      'leader_board' => Link::fromTextAndUrl(t('Leaderboard'), Url::fromRoute('<current>', [], [
        'fragment' => 'leaderboard',
      ])),
      'rules' => Link::fromTextAndUrl(t('Prizes/Rules Details'), Url::fromRoute('<current>', [], [
        'fragment' => 'rules',
      ]))->toString(),
    ];
