...
Feature: Membership Calculator Paragraph
  ...
  Scenario: Step through membership calculator for Behat: Adult
    When I view node "membership_page"
    And I click on element "#membership-calc-wrapper .form-element-wrapper:contains('Behat: Adult') .btn:contains('select')"
    Then I click on element "#membership-calc-wrapper input[value='Next']"
  ...
  Scenario: Step through membership calculator for Behat: Family 1
    When I view node "membership_page"
    And I click on element "#membership-calc-wrapper .form-element-wrapper:contains('Behat: Family 1') .btn:contains('select')"
    Then I click on element "#membership-calc-wrapper input[value='Next']"
    And I wait for AJAX to finish
    And I select the radio button "Behat branch"
    Then I click on element "#membership-calc-wrapper input[value='Next']"
