...
var _udn=KronosUTMDomain;		// (auto|none|domain) set the domain name for cookies
var _uhash="on";		// (on|off) unique domain hash for cookies
var _utimeout="1800";   	// set the inactive session timeout in seconds
var _ugifpath=KronosUTMGifPath;	// set the web path to the __utm.gif file
...
var _uOno=new Array();
_uOno[0]="kronostm.com"
_uOno[1]="kronostm"
_uOno[2]="www.kronostm.com"
//_uOno[0]="urchin";
//_uOno[1]="urchin.com";
...
var _uRno=new Array();
_uRno[0]=".kronostm.com";
//_uRno[0]=".urchin.com";

//-- **** Don't modify below this point ***
var _uff,_udh,_udt,_ubl=0,_udo="",_uu,_ufns=0,_uns=0,_ur="-",_ufno=0,_ust=0,_ubd=document,_udl=_ubd.location,_udlh="",_uwv="1",_kc=false;
...
function _uCInfo() {
 ...
 if (_ur=="0" && _kc) return "";
 if (c=="-" || c=="") {
  if (_ufns==1) { c="utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)"; }
  if (c=="-" || c=="") return "";
 }
 if (z!="-") {
  i=z.indexOf(".");
  ...
  if (t.toLowerCase()==c.toLowerCase()) {
	  ...
	  var a=_uFixA(_ubd.cookie,";",_ust), nx=" expires="+_uNx()+";";
	  _ubd.cookie="__utma="+a+"; path="+_utcp+";"+nx+_udo;
  }
  t=z.substring(0,i);
