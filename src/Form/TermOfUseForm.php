 ...
 */
class TermOfUseForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#title'] = t('Terms of Use');

    $form['participant'] = [
      '#type' => 'checkbox',
      '#title' => 'We agree to the <a target="_blank" href="https://github.com/ymcatwincities/openy/wiki/Open-Y-Participant-Agreement">Open Y Participant Agreement</a> and <a target="_blank" href="https://github.com/ymcatwincities/openy/wiki/Open-Y-Terms-of-Use">Terms of Use</a>',
      '#weight' => 1,
    ];

    $form['llc'] = [
      '#type' => 'checkbox',
      '#title' => 'Open Y, LLC is a separate entity established by YMCA of the Greater Twin Cities to support and amplify digital collaboration among YMCA associations. YUSA supports the Open Y platform with respect to use by its Member Associations but is not responsible for and does not control the services provided by Open Y, LLC.',
      '#weight' => 2,
    ];

    $form['privacy'] = [
      '#type' => 'checkbox',
      '#title' => 'Open Y recommends that each participating YMCA association develop and implement its own cybersecurity policies and obtain cyber liability and data privacy insurance.',
      '#weight' => 3,
    ];
    ...
    $form['obtaining'] = [
      '#type' => 'checkbox',
      '#title' => 'Open Y recommends obtaining a reputable agency to assist with the implementation of the Open Y platform and further development for your specific needs.',
      '#weight' => 5,
    ];
