...
namespace Drupal\openy_digital_signage_personify_schedule\Form;
...
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'openy_digital_signage_personify_schedule_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['openy_digital_signage_personify_schedule.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('openy_digital_signage_personify_schedule.settings');
    /* @var \Drupal\ymca_mappings\LocationMappingRepository $mapping */
    $mapping = \Drupal::service('ymca_mappings.location_repository');
    $entities = $mapping->loadAllLocationsWithPersonifyId();
    $locations = [];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('openy_digital_signage_personify_schedule.settings')
