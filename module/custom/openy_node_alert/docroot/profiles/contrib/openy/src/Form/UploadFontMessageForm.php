...
To use Cachet fonts on the Open Y website go to the <a href=\'@config_url\'>Open Y Font Settings page</a> and upload the font files there.
<img src="../profiles/contrib/openy/src/Form/uploadfont.png">', ['@config_url' => "$base_url/admin/appearance/font/local_font_config_entity"]),
    ];
