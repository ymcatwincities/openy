    ...
    attach: function (context, settings) {
      function sidebarAffix() {
        ...
        if (contentHeight > sidebarHeight) {
          ...
          $sidebar.unbind();
          var top_offset = $('.nav-global').outerHeight(true) + $('#block-openy-lily-main-menu').outerHeight(true) + $('.breadcrumb-container').outerHeight(true) + $('.site-alert--header').outerHeight(true) + $('.landing-header').outerHeight(true) + $('#block-tabs').outerHeight(true);
